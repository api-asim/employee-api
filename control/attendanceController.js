...
//  * @param {number} year
//  * @param {number} month
//  * @param {boolean} isIndividualReport 
//  * @param {object} record
//  */
...
//         report.totalWorkDurationHours = (empAttendance.reduce((sum, r) => sum + (r.workDuration || 0), 0) / 60).toFixed(2);
//         
...
//         const localMoment = moment(checkInTime).tz(LOCAL_TIMEZONE).startOf('day');
//         const todayStartLocal = localMoment.toDate(); 
